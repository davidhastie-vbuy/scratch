...
import { Home, Briefcase, FileText, MessageSquare, HelpCircle, User, Clock, Wrench, AlertTriangle, XCircle, ImageIcon } from "lucide-react";
...
const navItems = [
  ...
  { label: "Portfolio", path: "/provider/portfolio", icon: <ImageIcon className="h-4 w-4" /> },
